...
from git_dbx_cicd.tasks.sample_etl_task import SampleETLTask
from git_dbx_cicd.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/git_dbx_cicd/sample_experiment"
    }
